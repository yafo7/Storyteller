...
const server = http.createServer((request, response) => {
  ...
  if (!existsSync(file) || !statSync(file).isFile()) return response.writeHead(404, { 'Content-Type': 'text/plain; charset=utf-8' }).end('Not found');
...
server.listen(port, host, () => console.log(`Interactive stage ready at http://${host}:${port}`));
