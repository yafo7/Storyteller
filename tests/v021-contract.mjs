...
for(const [name,[w,h]] of Object.entries({'tileset.png':[128,64],'actors.png':[192,144],'portraits.png':[256,64],'ui-icons.png':[128,16]})){
...
console.log(JSON.stringify({status:'pass',maps:5,routeSteps:route.steps,assets:4,saveKey:production.saveKey},null,2));
